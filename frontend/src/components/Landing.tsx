    ...
    <div className="landing-page">
      ...
      <header className="hero">
        <div className="wrap hero-grid">
          <div>
            <h1>AI edits your résumé. <span className="g">You keep every version.</span></h1>
          ...
          <div className="reveal d2">
            <div className="assist">
              ...
              <div className="abody">
                <div className="user-bubble">Tailor my résumé for a backend role at Acme.</div>
                <p className="a-prose">Made a tailored copy of your résumé with 3 changes:</p>
                <div className="prop">
      ...
      <section className="section" id="how">
        <div className="wrap">
          ...
          <p className="one">Under the hood your résumé is <b style={{ color: "var(--text)" }}>structured data (JSON)</b>, so the assistant edits it precisely, field by field, instead of handing you text to copy-paste back. Every change is easy to review.</p>

          <div className="steps">
            <div className="step s1">
              <div className="srail"><span className="node" /></div>
              <div className="meta">
                <div className="ref">01 · ask</div>
                <h3>Ask in plain English</h3>
                <p>Tell the assistant what to change. It reads your history and edits the résumé for you.</p>
              </div>
              <div className="shot">
                <div className="frame">
                  <div className="chrome"><span className="dots"><i /><i /><i /></span><span className="addr">resume-git · assistant</span></div>
            ...
            <div className="step s2">
              <div className="srail"><span className="node" /></div>
              <div className="meta">
                <div className="ref">02 · review</div>
              ...
              <div className="shot">
                <div className="frame">
                  <div className="chrome"><span className="dots"><i /><i /><i /></span><span className="addr">resume-git · compare</span></div>
            ...
            <div className="step s3">
              <div className="srail"><span className="node" /></div>
              <div className="meta">
                <div className="ref">03 · keep</div>
                <h3>Save it, get the PDF</h3>
                <p>Approved changes are saved as a new version, and a one-page PDF compiles as you go.</p>
              </div>
              <div className="shot">
                <div className="frame">
                  <div className="chrome"><span className="dots"><i /><i /><i /></span><span className="addr">resume-git · edit</span></div>
          ...
          <div className="grid4">
            <div className="hl"><div className="t"><span className="d" style={{ background: "var(--accent)" }} />Structured data (JSON)</div><p>Your résumé is real data, not a document, so the AI edits it precisely and every change is reviewable.</p></div>
      ...
      <section className="section">
        <div className="wrap who">
          ...
          <p>It builds the clean, single-page LaTeX résumé that's become the default for CS and software roles. You get the ATS-friendly PDF recruiters expect, with no LaTeX to write.</p>
      ...
      <section className="cta">
        <div className="wrap">
          <h2>Get started.</h2>
          <p>Bring your current résumé or start from scratch.</p>
          <div className="cta-row"><a className="btn accent lg" href={GOOGLE_LOGIN_URL}>Continue with Google</a></div>
          <p className="fine">We only use your Google account to sign you in. Your résumé stays private to your account.</p>
        </div>
      </section>
